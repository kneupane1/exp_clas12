...
private:
  ...
  std::string w_range_name[w_range_num] = {
      " W<2.5 ", " 2.5<W<3.5 "}; //{" W<2.0 ", " 2.0<W<2.5 ", " 2.5<W<3.0 ",
                                 //" 3.0<W<3.5 "};
...
public:
  ...
  void Fill_W_2pi_all_sec(float W, float q2, float W_2pi, float W_dpp,
                          float delta_zero_, float rho_, float weight);
  void Fill_W_hist_Xpip_all_sec(float W, float weight);

  void Fill_W_2pi_thrown(float W, float q2, float W_2pi, float W_dpp,
                         float delta_zero_, float rho_, float weight);
  ...
  void Fill_Angles(float W, float q2, float theta_p, float theta_pip,
                   float theta_pim, float phi_p, float phi_pip, float phi_pim,
                   float alpha_p, float alpha_pip, float alpha_pim,
                   float weight);
  void Fill_Angles_thrown(float W, float q2, float theta_p, float theta_pip,
  ...
  void Fill_hist_mass_vs_q2_prot(float w, float m_p, float theta, float q2,
                                 float wt);
  void Fill_hist_mass_vs_q2_pip(float w, float m_pip, float theta, float q2,
                                float wt);
  void Fill_hist_mass_vs_q2_pim(float w, float m_pim, float theta, float q2,
                                float wt);
  ...
  void Fill_theta_P_inv_mass(float W, float q2, float inv_mass, float theta,
                             float wt);
  void Fill_theta_pim_inv_mass(float W, float q2, float inv_mass, float theta,
                               float wt);
  void Fill_theta_pip_inv_mass(float W, float q2, float inv_mass, float theta,
                               float wt);

  void Fill_theta_P_lab_inv_mass(float W, float q2, float inv_mass, float theta,
                                 float wt);
  void Fill_theta_pim_lab_inv_mass(float W, float q2, float inv_mass,
                                   float theta, float wt);
  void Fill_theta_pip_lab_inv_mass(float W, float q2, float inv_mass,
                                   float theta, float wt);

  void Fill_theta_P_inv_mass_thrown(float W, float q2, float inv_mass,
                                    float theta, float wt);
  void Fill_theta_pim_inv_mass_thrown(float W, float q2, float inv_mass,
                                      float theta, float wt);
  void Fill_theta_pip_inv_mass_thrown(float W, float q2, float inv_mass,
                                      float theta, float wt);

  void Fill_theta_P_lab_inv_mass_thrown(float W, float q2, float inv_mass,
                                        float theta, float wt);
  void Fill_theta_pim_lab_inv_mass_thrown(float W, float q2, float inv_mass,
                                          float theta, float wt);
  void Fill_theta_pip_lab_inv_mass_thrown(float W, float q2, float inv_mass,
                                          float theta, float wt);
