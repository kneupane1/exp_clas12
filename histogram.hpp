...
TH2D *theta_pim_vs_mass_Ppip_thrown[w_range_num];
TH2D *theta_pip_vs_mass_Ppim_thrown[w_range_num];
TH2D *theta_P_vs_mass_pip_pim_thrown[w_range_num];

TH2D *theta_pim_lab_vs_mass_Ppip_thrown[w_range_num];
TH2D *theta_pip_lab_vs_mass_Ppim_thrown[w_range_num];
TH2D *theta_P_lab_vs_mass_pip_pim_thrown[w_range_num];
TH1D *W_hist_singlepip[sec_num];
TH1D *W_hist_Xpip_all_sec;

TH1D *W_hist_twopi_thrown[w_range_num];
TH1D *inv_mass_P_pip_thrown[w_range_num];
TH1D *inv_mass_P_pim_thrown[w_range_num];
TH1D *inv_mass_pip_pim_thrown[w_range_num];
...
void Fill_W_2pi_thrown(float W, float W_2pi, float W_dpp, float delta_zero_, float rho_,
                       float weight);
...
void Fill_theta_P_inv_mass_thrown(float W, float inv_mass, float theta, float wt);
void Fill_theta_pim_inv_mass_thrown(float W, float inv_mass, float theta, float wt);
void Fill_theta_pip_inv_mass_thrown(float W, float inv_mass, float theta, float wt);

void Fill_theta_P_lab_inv_mass_thrown(float W, float inv_mass, float theta_lab,
                                      float wt);
void Fill_theta_pim_lab_inv_mass_thrown(float W, float inv_mass, float theta_lab,
                                        float wt);
void Fill_theta_pip_lab_inv_mass_thrown(float W, float inv_mass, float theta_lab,
                                        float wt);
