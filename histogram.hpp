...
class Histogram {
 ...
 public:
  ...
  void Fill_Angles(float W, float q2, float theta_p, float theta_pip, float theta_pim, float phi_p, float phi_pip,
                   float phi_pim, float alpha_p, float alpha_pip, float alpha_pim, float weight);
  void Fill_Angles_thrown(float W, float q2, float theta_p, float theta_pip, float theta_pim, float phi_p,
                          float phi_pip, float phi_pim, float alpha_p, float alpha_pip, float alpha_pim, float weight);
