...
void Histogram::Fill_EC_sampling_fraction(double momentum, double sf, int sec_number, float weight) {
        if (sec_number == sec_number && sec_number >= 0 && sec_number < 7) {
...
void Histogram::Fill_WvsmmSQ_ep(double W, double mmSQ, int sec_number, float weight) {
        if (sec_number == sec_number && sec_number >= 0 && sec_number < 7) {
                W_hist_ep[sec_number]->Fill(W, weight);
                W_vs_mmSQ_ep[sec_number][0] -> Fill(W, mmSQ, weight);
        }
}
void Histogram::Fill_W_2pi_all_sec(double W, double W_dpp, double delta_zero_, double rho_, float weight) {
...
void Histogram::Fill_W_hist_Xpip_all_sec(double W, float weight) { W_hist_Xpip_all_sec->Fill(W, weight); }
...
void Histogram::Fill_WvsmmSQ_singlepip(double W, double mmSQ, int sec_number, float wt) {
        if (sec_number == sec_number && sec_number >= 0 && sec_number < 7) {
...
void Histogram::Fill_WvsmmSQ_anti_singlepip(double W, double mmSQ, int sec_number, float wt) {
        if (sec_number == sec_number && sec_number >= 0 && sec_number < 7) {
...
void Histogram::Fill_theta_P_lab_inv_mass(float inv_mass, float theta_lab, float wt) {
        theta_P_lab_vs_mass_pip_pim->Fill(inv_mass, theta_lab, wt);
}
void Histogram::Fill_theta_pim_lab_inv_mass(float inv_mass, float theta_lab, float wt) {
        theta_pim_lab_vs_mass_Ppip->Fill(inv_mass, theta_lab, wt);
}
void Histogram::Fill_theta_pip_lab_inv_mass(float inv_mass, float theta_lab, float wt) {
