...
void datahandeler(std::string fin, std::string fout) {
        ...
        for (int current_event = 0; current_event < num_of_events; current_event++) {
                ...
                // if (mc_pid->size() != 0 && mc_pid->at(0) == ELECTRON /* charge->at(0) >= 0*/) {  // cut # 1
                //
                //         event->SetElec_thrown(mc_px->at(0), mc_py->at(0), mc_pz->at(0), MASS_E);
                //         hist->Fill_W_vs_Q2_thrown(event->W_thrown(), event->Q2_thrown(), mc_weight);
                //
                //         for (int part = 1; part < mc_pid->size(); part++) {
                //                 if (mc_pid->at(part) == PROTON)
                //                         event->SetProt_thrown(mc_px->at(part), mc_py->at(part), mc_pz->at(part), MASS_P);
                //
                //                 if (mc_pid->at(part) == PIP) event->SetPip_thrown(mc_px->at(part), mc_py->at(part), mc_pz->at(part), MASS_PIP);
                //                 if (mc_pid->at(part) == PIM) event->SetPim_thrown(mc_px->at(part), mc_py->at(part), mc_pz->at(part), MASS_PIM);
                //         }
                //         event->thrownCalc();
                //         //std::cout << event->W_2pi_thrown()<<" w_rho  "<<event->W_rho_thrown()<<  '\n';
                //         hist->Fill_W_2pi_thrown(event->W_thrown(), event->Q2_thrown(), event->W_2pi_thrown(), event->W_delta_pp_thrown(),
                //                                 event->W_delta_zero_thrown(), event->W_rho_thrown(), mc_weight);
                //
                //         hist->Fill_theta_P_inv_mass_thrown(event->W_thrown(), event->Q2_thrown(), event->W_rho_thrown(),
                //                                            (event->p_mu_prime_cm_thrown().Theta() * (180 / PI)), mc_weight);
                //
                //         hist->Fill_theta_pim_inv_mass_thrown(event->W_thrown(), event->Q2_thrown(), event->W_delta_pp_thrown(),
                //                                              (event->pim_mu_prime_cm_thrown().Theta() * (180 / PI)), mc_weight);
                //         hist->Fill_theta_pip_inv_mass_thrown(event->W_thrown(), event->Q2_thrown(), event->W_delta_zero_thrown(),
                //                                              (event->pip_mu_prime_cm_thrown().Theta() * (180 / PI)), mc_weight);
                //
                //         hist->Fill_theta_P_lab_inv_mass_thrown(event->W_thrown(), event->Q2_thrown(), event->W_rho_thrown(),
                //                                                (event->p_mu_prime_thrown().Theta() * (180 / PI)), mc_weight);
                //         hist->Fill_theta_pim_lab_inv_mass_thrown(event->W_thrown(), event->Q2_thrown(), event->W_delta_pp_thrown(),
                //                                                  (event->pim_mu_prime_thrown().Theta() * (180 / PI)), mc_weight);
                //         hist->Fill_theta_pip_lab_inv_mass_thrown(event->W_thrown(), event->Q2_thrown(), event->W_delta_zero_thrown(),
                //                                                  (event->pip_mu_prime_thrown().Theta() * (180 / PI)), mc_weight);
                //
                //         event->AlphaCalc_thrown();
                //         hist->Fill_Angles_thrown(event->W_thrown(), event->Q2_thrown(), event->p_mu_prime_cm_thrown().Theta() * 180 / PI,  event->pip_mu_prime_cm_thrown().Theta() * 180 / PI,  event->pim_mu_prime_cm_thrown().Theta() * 180 / PI,
                //                                  event->p_mu_prime_cm_thrown().Phi() * 180 / PI, event->pip_mu_prime_cm_thrown().Phi() * 180 / PI, event->pim_mu_prime_cm_thrown().Phi() * 180 / PI,
                //                                  event->alpha_pippim_pipf_thrown(), event->alpha_ppim_pipip_thrown(), event->alpha_ppip_pipim_thrown(), mc_weight);
                // }
                        ...
                        if (good_e) { // cut # 2
                                ...
                                if (event->e_mu_prime().P() != 0) {
                                        hist->Fill_EC_sampling_fraction(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                        dc_sec->at(0), mc_weight);
                                        if (event->e_mu_prime().P() > 1.0 && event->e_mu_prime().P() < 1.3)
                                                hist->Fill_1d_sampling_fraction_1(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);

                                        if (event->e_mu_prime().P() > 1.3 && event->e_mu_prime().P() < 1.6)
                                                hist->Fill_1d_sampling_fraction_2(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 1.6 && event->e_mu_prime().P() < 1.9)
                                                hist->Fill_1d_sampling_fraction_3(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 1.9 && event->e_mu_prime().P() < 2.2)
                                                hist->Fill_1d_sampling_fraction_4(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 2.2 && event->e_mu_prime().P() < 2.5)
                                                hist->Fill_1d_sampling_fraction_5(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 2.5 && event->e_mu_prime().P() < 2.8)
                                                hist->Fill_1d_sampling_fraction_6(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 2.8 && event->e_mu_prime().P() < 3.1)
                                                hist->Fill_1d_sampling_fraction_7(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 3.1 && event->e_mu_prime().P() < 3.4)
                                                hist->Fill_1d_sampling_fraction_8(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 3.4 && event->e_mu_prime().P() < 3.7)
                                                hist->Fill_1d_sampling_fraction_9(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                  sector, mc_weight);
                                        if (event->e_mu_prime().P() > 3.7 && event->e_mu_prime().P() < 4.0)
                                                hist->Fill_1d_sampling_fraction_10(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                        if (event->e_mu_prime().P() > 4.0 && event->e_mu_prime().P() < 4.3)
                                                hist->Fill_1d_sampling_fraction_11(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                        if (event->e_mu_prime().P() > 4.3 && event->e_mu_prime().P() < 4.6)
                                                hist->Fill_1d_sampling_fraction_12(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);

                                        if (event->e_mu_prime().P() > 4.6 && event->e_mu_prime().P() < 4.9)
                                                hist->Fill_1d_sampling_fraction_13(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);

                                        if (event->e_mu_prime().P() > 4.9 && event->e_mu_prime().P() < 5.2)
                                                hist->Fill_1d_sampling_fraction_14(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                        if (event->e_mu_prime().P() > 5.2 && event->e_mu_prime().P() < 5.5)
                                                hist->Fill_1d_sampling_fraction_15(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                        if (event->e_mu_prime().P() > 5.5 && event->e_mu_prime().P() < 5.8)
                                                hist->Fill_1d_sampling_fraction_16(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);

                                        if (event->e_mu_prime().P() > 5.8 && event->e_mu_prime().P() < 6.1)
                                                hist->Fill_1d_sampling_fraction_17(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                        if (event->e_mu_prime().P() > 6.1 && event->e_mu_prime().P() < 6.4)
                                                hist->Fill_1d_sampling_fraction_18(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                        if (event->e_mu_prime().P() > 6.4 && event->e_mu_prime().P() < 6.7)
                                                hist->Fill_1d_sampling_fraction_19(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                        if (event->e_mu_prime().P() > 6.7 && event->e_mu_prime().P() < 7.0)
                                                hist->Fill_1d_sampling_fraction_20(event->e_mu_prime().P(), (ec_tot_energy->at(0) / event->e_mu_prime().P()),
                                                                                   sector, mc_weight);
                                ...
                                for (int part = 1; part < pid->size(); part++) {
                                        ...
                                        if (/*event->W() < 1.40 &&  event->W() > 1.20 &&*/ event->Q2() < 15.0 && event->Q2() > 0.0) { // cut # 5
                                                ...
                                                if (charge->at(part) == -1) { // cut # 6
                                                        ...
                                                        //         hist->Fill_deltat_pion(pid->at(part), charge->at(part), dt->dt_Pi(), p->at(part));
                                                        // }
                                                        ...
                                                        //         }
                                                        // }
                                                        if ((abs(dt->dt_Pi()) < 0.5 || abs(dt->dt_ctof_Pi()) < 0.5) && (pid->at(part) == PIM)) { // cut # 8
                                                                ...
                                                                good_pim = e_cuts->pim_cuts(status->at(part), charge->at(part), event->pim_mu_prime().P(), pid->at(part),
                                                                                            chi2pid->at(part));
                                                                good_hadron_ctof_pim = e_cuts->hadron_cuts_ctof(
                                                                        status->at(part), charge->at(part), event->pim_mu_prime().P(), pid->at(part), chi2pid->at(part));
                                                        ...
                                                        // // hist->Fill_ctof_e_without_cut_hist(pid->at(0), charge->at(0),
                                                        // //                                 dt->dt_ctof_E(), p->at(0));
                                    ...
                                    (good_pim || good_hadron_ctof_pim)) { // cut # 10 11 12
                                        ...
                                        if (event->elecProtEvent()) {
                                                ...
                                                if (event->MM2() < 0.2 && event->MM2() > -0.1) {
                                                        hist->Fill_WvsmmSQ_ep(event->W_ep(), event->MM2(), sector, mc_weight);

                                                } else {
                                                        hist->Fill_WvsmmSQ_anti_ep(event->W_ep(), event->MM2(), sector, mc_weight);
                                                }
                                                //}
                                                ...
                                                if (event->MM2() < 0.01 && event->MM2() > -0.01) { // cut # 14
                                                        ...
                                                        //hist->Fill_deltat_ctof_prot_after(pid_of_part, charge_at_part, dt->dt_ctof_P(), dt->dt_ctof_Pi(),
                                                        //                                  mom_at_part);
                                                        ...
                                                        hist->Fill_Angles(event->W(), event->Q2(), event->p_mu_prime_cm().Theta() * 180 / PI,  event->pip_mu_prime_cm().Theta() * 180 / PI,  event->pim_mu_prime_cm().Theta() * 180 / PI,
                                                                          event->p_mu_prime_cm().Phi() * 180 / PI, event->pip_mu_prime_cm().Phi() * 180 / PI, event->pim_mu_prime_cm().Phi() * 180 / PI,
                                                                          event->alpha_pippim_pipf(), event->alpha_ppim_pipip(), event->alpha_ppip_pipim(), mc_weight);
                                                } else {
                                        ...
                                        if (event->elecWopEvent()) {
                                                ...
                                                if (event->MM_wop() < 1.05 && event->MM2_wop() > 0.65) {
                                                        //hist->Fill_deltat_after_mmsq_cut_Xpip(pid_of_part, charge_at_part, dt->dt_P(), dt->dt_Pi(), mom_at_part);
                                                        //hist->Fill_deltat_ctof_after_mmsq_cut_Xpip(pid_of_part, charge_at_part, dt->dt_ctof_P(), dt->dt_ctof_Pi(),
                                                        //                                           mom_at_part);

                                                        hist->Fill_WvsmmSQ_singlepip(event->W_singlepip(), event->MM2_wop(), sector, mc_weight);
                                                        hist->Fill_W_hist_Xpip_all_sec(event->W_singlepip(), mc_weight);

                                                } else {
                                                        hist->Fill_WvsmmSQ_anti_singlepip(event->W_singlepip(), event->MM2_wop(), sector, mc_weight);
                                                }
                                        }
                                }
