...
void datahandeler(std::string fin, std::string fout) {
        ...
        int total = 0;
        int no_pr_pip_overlap = 0;
        int no_e_as_well_pim = 0;
        int no_p_as_well_pip = 0;
        int no_ele = 0;
        int no_pim = 0;
        int no_pip = 0;
        int no_proton_ftof = 0;
        int no_pim_ftof = 0;
        int no_pip_ftof = 0;
        int no_proton_ctof = 0;
        int no_pim_ctof = 0;
        int no_pip_ctof = 0;
        int no_proton = 0;
        int pid_size_1 = 0;
        ...
        for (int current_event = 0; current_event < num_of_events; current_event++) {
                ...
                if (good_e) { // cut # 2
                        ...
                        if (p->at(0) > -1.0) {
                                no_ele += 1;
                                pid_check_el = pid->at(0);
                                hist->Fill_mom_ele(event->e_mu_prime().P(), event->e_mu_prime().Pz());
                        }
                                ...
                                if (/*event->W() < 1.40 &&  event->W() > 1.20 &&*/ event->Q2() < 15.0 &&
                                        ...
                                        if (charge->at(part) == -1) { // cut # 6
                                                ...
                                                if (abs(dt->dt_Pi()) < 10.1) { // cut # 7
                                                        hist->Fill_deltat_pip(pid->at(part), charge->at(part),
                                                                              dt->dt_Pi(), p->at(part));
                                                        if (good_pim)
                                                                no_pim_ftof += 1;
                                                }
                                                if (abs(dt->dt_ctof_Pi()) < 10.1) {
                                                        hist->Fill_ctof_pim_without_cut_hist(
                                                                pid->at(part), charge->at(part), dt->dt_ctof_Pi(),
                                                                p->at(part));
                                                        if (good_hadron_ctof_pim)
                                                                no_pim_ctof += 1;
                                                        if (abs(dt->dt_ctof_Pi()) < 0.5 && good_hadron_ctof_pim) {

                                                                hist->Fill_ctof_pim_with_cut_hist(
                                                                        pid->at(part), charge->at(part), dt->dt_ctof_Pi(),
                                                                        p->at(part));
                                                        }
                                                }
                                                if (abs(dt->dt_Pi()) < 0.5 ||
                                                    abs(dt->dt_ctof_Pi()) < 0.5) /*&&
                                                                                    if (pid->at(part) == PIM)*/
                                                { // cut # 8
                                                        ...
                                                        good_hadron_ctof_pim = e_cuts->hadron_cuts_ctof(
                                                                status->at(part), charge->at(part), event->pim_mu_prime().P(),
                                                                pid->at(part), chi2pid->at(part));
                                                ...
                                                hist->Fill_ctof_km_without_cut_hist(pid->at(part), charge->at(part),
                                                                                    dt->dt_ctof_K(), p->at(part));
                                                if (abs(dt->dt_ctof_K()) < 0.5) {
                                                        hist->Fill_ctof_km_with_cut_hist(pid->at(part), charge->at(part),
                                                                                         dt->dt_ctof_K(), p->at(part));
                                                }
                                                ...
                                                if (abs(dt->dt_ctof_P()) < 10.5) {
                                                        hist->Fill_ctof_P_without_cut_hist(pid->at(part),
                                                                                           charge->at(part),
                                                                                           dt->dt_ctof_P(), p->at(part));
                                                        // if (good_hadron_ctof_P)
                                                        no_proton_ctof += 1;
                                                        if (abs(dt->dt_ctof_P()) < 0.5) {

                                                                hist->Fill_ctof_P_with_cut_hist(pid->at(part), charge->at(part),
                                                                                                dt->dt_ctof_P(), p->at(part));
                                                        }
                                                }
                                                if (abs(dt->dt_Pi()) < 10.1) { // cut # 7
                                                ...
                                                if (abs(dt->dt_ctof_Pi()) < 10.1) {
                                                        // if (good_hadron_ctof_pip)
                                                        no_pip_ctof += 1;
                                                        hist->Fill_ctof_pip_without_cut_hist(
                                                                pid->at(part), charge->at(part), dt->dt_ctof_Pi(),
                                                                p->at(part));
                                                        if ((dt->dt_ctof_Pi() < 0.5) && (dt->dt_ctof_Pi() > -0.30)) {
                                                                //(dt->dt_ctof_Pi() >= (0.67 * p->at(part) - 4.5)))
                                                                hist->Fill_ctof_pip_with_cut_hist(
                                                                        pid->at(part), charge->at(part), dt->dt_ctof_Pi(),
                                                                        p->at(part));
                                                        }
                                                }
                                                if (abs(dt->dt_P()) < 0.6 /*&& abs(dt->dt_Pi()) > 0.5)*/ ||
                                                    abs(dt->dt_ctof_P()) < 0.5) /*&& abs(dt->dt_ctof_Pi()) > 0.5))
                                                                                || (pid->at(part) == PROTON)*/
                                                ...
                                                { // cut 9
                                                ...
                                                } else if (abs(dt->dt_Pi()) < 0.50 /* && abs(dt->dt_P()) > 0.6 )*/
                                                           || (dt->dt_ctof_Pi() < 0.5 && dt->dt_ctof_Pi() > -0.3 /*&& abs(dt->dt_ctof_P()) > 0.5)) || (pid->at(part) == PIP)*/)) { // cut 9
                                                        ...
                                                        good_hadron_ctof_pip = e_cuts->hadron_cuts_ctof(
                                                                status->at(part), charge->at(part), event->pip_mu_prime().P(),
                                                                pid->at(part), chi2pid->at(part));

                                                } else if ((abs(dt->dt_P()) < 0.6 && abs(dt->dt_Pi()) < 0.5) ||
                                                ...
                                                //}
                                                // if (abs(dt->dt_ctof_K()) < 10.1) {
                                                hist->Fill_ctof_kp_without_cut_hist(pid->at(part), charge->at(part),
                                                                                    dt->dt_ctof_K(), p->at(part));
                                                if ((((dt->dt_K() > -0.50) && (dt->dt_K() < 0.50)) ||
                                                     (dt->dt_ctof_K() < 0.5 && dt->dt_ctof_K() > -0.5)) /*&&
                                                                                                            (pid->at(part) == KP)*/) {
                                                        hist->Fill_ctof_kp_with_cut_hist(pid->at(part), charge->at(part),
                                                                                         dt->dt_ctof_K(), p->at(part));
                                                }
                                                //}
                                                ...
                                                if (/*event->W() < 1.40 &&  event->W() > 1.20 &&*/ event->Q2() < 15.0 &&
                                                                                                   event->Q2() > 0.0 /*&& (good_p || good_hadron_ctof_P) &&
                                                                                                                        ...
                                                                                                                        (good_pim == true ||
                                                                                                                        good_hadron_ctof_pim == true)*/) { // cut # 10 11 12
                                                        event->CalcMissMass();
                                                        ...
                                                        if (event->elecProtEvent()) {
                                                                ...
                                                                if (event->MM2() < 0.03 && event->MM2() > -0.03) { // cut # 14
                                                                        ...
                                                                        // if (abs(dt->dt_P()) < 0.6)
                                                                        hist->Fill_deltat_prot_after(pid->at(part), charge->at(part),
                                                                                                     dt->dt_P(), dt->dt_Pi(),
                                                                                                     p->at(part));
                                                                        // if (dt->dt_ctof_P() < 0.5 && dt->dt_ctof_P() > -0.5)
                                                                        hist->Fill_deltat_ctof_prot_after(
                                                                                pid->at(part), charge->at(part), dt->dt_ctof_P(), dt->dt_ctof_Pi(),
                                                                                p->at(part));

                                                                        hist->Fill_WvsmmSQ_2pi(event->W_2pi(), event->W_delta_pp(),
                                                                                               event->W_delta_zero(), event->W_rho(),
                                                                                               event->MM2(), sector, mc_weight);
                                                                        hist->Fill_W_2pi_all_sec(event->W_2pi(), event->W_delta_pp(),
                                                                                                 event->W_delta_zero(), event->W_rho(),
                                                                                                 mc_weight);

                                                                        hist->Fill_theta_P_inv_mass(
                                                                                event->W_rho(), (event->p_mu_prime_cm().Theta() * (180 / PI)),
                                                                                mc_weight);
                                                                        ...
                                                                        hist->Fill_theta_P_lab_inv_mass(
                                                                                event->W_rho(), (event->p_mu_prime().Theta() * (180 / PI)),
                                                                                mc_weight);
                                                        ...
                                                        if (event->elecWopEvent()) {
                                                                ...
                                                                if (event->MM_wop() < 1.05 && event->MM2_wop() > 0.65) {
                                                                        hist->Fill_deltat_after_mmsq_cut_Xpip(pid->at(part), charge->at(part),
                                                                                                              dt->dt_P(), dt->dt_Pi(),
                                                                                                              p->at(part));
                                                                        hist->Fill_deltat_ctof_after_mmsq_cut_Xpip(
                                                                                pid->at(part), charge->at(part), dt->dt_ctof_P(), dt->dt_ctof_Pi(),
                                                                                p->at(part));
        ...
        std::cout << "no_of_ele  " << no_ele << " pim  " << no_pim << " pip  "
                  << no_pip << " proton " << no_proton << "  e_as_well_pim "
                  << no_e_as_well_pim << "  p_as_well_pip " << no_p_as_well_pip
                  << "  no_proton_pip_overlapping_region  " << no_pr_pip_overlap
                  << '\n';
        // std::cout << "pid size 1 " << pid_size_1 << "  size_2 " << pid_size_2 <<
        // " size_3 " << pid_size_3 << "  size_4 "
        //           << pid_size_4 << "  size_5 " << pid_size_5 << "  size_6 " <<
        //           pid_size_6 << "  size_7_or_greater "
        //           << pid_size_7 << '\n';
        std::cout << "pr_ftof " << no_proton_ftof << " pr_ctof " << no_proton_ctof
                  << " pip_ftof " << no_pip_ftof << " pip_ctof " << no_pip_ctof
                  << " pim_ftof " << no_pim_ftof << " pim_ctof " << no_pim_ctof
                  << '\n';
